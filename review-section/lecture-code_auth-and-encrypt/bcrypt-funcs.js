/*
Here are some helper functions that you'll probably find helpful for learning and exploring bcrypt.
*/
...
const tester = async (plainTextPassword, saltRounds = 10, shouldMatch = true) => {
